...
library(pastecs)
stat.desc(train_RMSE, norm = T, basic = F)
...
We made a crossvalidation on 5 folds. We found that the training error, M=0.3406479 and SE = 0.00606. The test error, M=0.3366132 and SE = 0.0240583. Thus performance of the model is only slightly better for the test than the trainingdata.
...
stat.desc(train_RMSE1, norm = T, basic = F)
stat.desc(test_RMSE1, norm = T, basic = F)
...
stat.desc(train_RMSE2, norm = T, basic = F)
stat.desc(test_RMSE2, norm = T, basic = F)
...
#Make the model
modelTD = lmer(CHI_MLU ~ VISIT + (1 + VISIT|SUBJ), trainingData[trainingData$Diagnosis == "TD",])

summary(modelTD)

#Calculate mean for each visit and subtract from bernies data
# mean = 1.08883+0.35337*visit
bernie

bernie$CHI_MLU[bernie$VISIT == "1"] - (1.08883 + 0.35337*1)
bernie$CHI_MLU[bernie$VISIT == "2"] - (1.08883 + 0.35337*2)
bernie$CHI_MLU[bernie$VISIT == "3"] - (1.08883 + 0.35337*3)
bernie$CHI_MLU[bernie$VISIT == "4"] - (1.08883 + 0.35337*4)
bernie$CHI_MLU[bernie$VISIT == "5"] - (1.08883 + 0.35337*5)
bernie$CHI_MLU[bernie$VISIT == "6"] - (1.08883 + 0.35337*6)


#Bernie actually performs better on the visits than a TD
predictInterval(modelTD, bernie)
predict(modelTD, bernie, allow.new.levels = T)
