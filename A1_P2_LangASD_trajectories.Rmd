...
MLU of the parents was significantly affected by diagnosis (beta = 0.502, SE = 0.12, t = 6.542, p < 0.05), meaning that parents iwth a typically developing child had a MLU that was 0.502 longer than parents of children with ASD.
...
What is going on is that parents are creating their MLU by time and that parents with children with ASD use a smaller MLU as their children normally use a smaller MLU as well.
